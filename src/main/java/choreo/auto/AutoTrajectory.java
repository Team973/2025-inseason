...
public class AutoTrajectory {
  ...
  public void cmdExecute() {
    ...
    SmartDashboard.putNumber("Pose X", poseSupplier.get().getX());
    SmartDashboard.putNumber("Pose Y", poseSupplier.get().getY());
    SmartDashboard.putNumber("Swerve Sample X", sample.getPose().getX());
    SmartDashboard.putNumber("Swerve Sample Y", sample.getPose().getY());
  }
  ...
  public Command cmd() {
    return new FunctionalCommand(
            this::cmdInitialize, this::cmdExecute, this::cmdEnd, this::cmdIsFinished)
