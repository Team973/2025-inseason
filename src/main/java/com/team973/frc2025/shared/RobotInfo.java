...
public final class RobotInfo {
  ...
  public static class DriveInfo {
    ...
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = fromBotVersion(-45.439, 264.902);

    public static final int FRONT_RIGHT_MODULE_DRIVE_MOTOR = 8;
    public static final int FRONT_RIGHT_MODULE_STEER_MOTOR = 9;
    public static final int FRONT_RIGHT_MODULE_STEER_ENCODER = 10;
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = fromBotVersion(31.728, 153.721);

    public static final int BACK_LEFT_MODULE_DRIVE_MOTOR = 5;
    public static final int BACK_LEFT_MODULE_STEER_MOTOR = 6;
    public static final int BACK_LEFT_MODULE_STEER_ENCODER = 7;
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = fromBotVersion(3.164, 50.713);
    ...
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = fromBotVersion(-30.322, 100.107);
