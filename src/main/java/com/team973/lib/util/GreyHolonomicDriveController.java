 ...
 */
public class GreyHolonomicDriveController {
  ...
  public ChassisSpeeds calculate(
    ...
    if (!m_enabled) {
      ...
      // CHANGE: We do not transform our chassis speed from the field relative robot
      // rotation. Because our DriveController type applies this transformation already.
    ...
    // CHANGE: We do not transform our chassis speed from the field relative robot
    // rotation. Because our DriveController type applies this transformation already.
    ChassisSpeeds out = new ChassisSpeeds(xFF + xFeedback, yFF + yFeedback, thetaFF);
    return out;
  }
